...
echo("<script language='javascript'>window.location.href='login.html';</script>");
 ...
 $sql="INSERT INTO `student-tb` (`registration-no`, `student-name`, `department`, `gender`, `dob`, `address`, `email-id`, `phone-no`) VALUES  ('$studentid','$name','$depname','$gender','$dob','$address','$email','$phone')";
 $result=mysql_query($sql);
 $sql="INSERT INTO `login-tb` (`username`, `password`, `designation`) VALUES ('$studentid','$password','student')";
 $result=mysql_query($sql);
 mysql_close($connect);
echo("<script language='javascript'>window.location.href='login.html';</script>");
  }
